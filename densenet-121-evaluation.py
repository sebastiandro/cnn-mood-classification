...
if __name__ == '__main__':
    ...
    # Load our model
    model = densenet121_model(img_rows=img_width, img_cols=img_height, color_type=channel, num_classes=num_classes)

    model.load_weights('models/cnn-densenet121-moods.h5')
